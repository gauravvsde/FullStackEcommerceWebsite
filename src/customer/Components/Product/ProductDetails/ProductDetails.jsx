...
const product = {
  ...
  details:
    'The 6-Pack includes two black, two white, and two heather gray Basic Tees. Sign up for our subscription service and be the first to receive new, exciting colors, such as our upcoming "Charcoal Gray" limited release.',
};
...
export default function ProductDetails() {
  const [selectedSize, setSelectedSize] = useState({ name: "S" });
            ...
            <div className="mt-4 lg:row-span-3 lg:mt-0">
              ...
              <div className="flex space-x-5 items-center text-lg lg:text-xl tracking-tight text-gray-900 mt-6">
                ...
                <p className="text-green-600 font-semibold">
                  {customersProduct.product?.discountPresent}% Off
                </p>
              </div>
              ...
              <Grid item xs={5}>
                ...
                <Box>
                  ...
                  >
                    ...
                    <Grid xs={2}>
                      <p className="opacity-50 p-2">60</p>
                    </Grid>
                  </Grid>
                </Box>
                <Box>
                  ...
                  >
                    ...
                    <Grid xs={2}>
                      <p className="opacity-50 p-2">20</p>
                    </Grid>
                  </Grid>
                </Box>
                <Box>
                  ...
                  >
                    ...
                    <Grid xs={2}>
                      <p className="opacity-50 p-2">10</p>
                    </Grid>
                  </Grid>
                </Box>
                <Box>
                  ...
                  >
                    ...
                    <Grid xs={2}>
                      <p className="opacity-50 p-2">5</p>
                    </Grid>
                  </Grid>
                </Box>
                <Box>
                  ...
                  >
                    ...
                    <Grid xs={2}>
                      <p className="opacity-50 p-2">1</p>
                    </Grid>
                  </Grid>
                </Box>
              </Grid>
