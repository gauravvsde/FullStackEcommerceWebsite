...
export default function Product() {
  ...
  // console.log("elements", customersProduct.products.numberOfElements);
          ...
          <section aria-labelledby="products-heading" className="pb-24 pt-6">
            ...
            <div>
              ...
              <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-5">
                ...
                {customersProduct.products.numberOfElements > 0 ? (
                  <div className="lg:col-span-4 w-full">
                    <div className="flex flex-wrap justify-center bg-white border py-5 rounded-md">
                      {customersProduct.products.content.map((item) => (
                  ...
                  <div className="lg:col-span-4 w-full text-center">
                    <p>Currently Out of Stock, Will be available soon</p>
                  </div>
                )}
              </div>
            </div>
